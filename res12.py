    ...
    def forward(self, x):
        ...
        if self.drop_rate > 0:
            if self.drop_block:
                ...
                # print("block_szie:", self.block_size)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block=BasicBlock, keep_prob=1.0, avg_pool=True, out_dim = 128, drop_rate=0.1, dropblock_size=5,
        ...
        self.drop_rate = drop_rate
        # self.projection_head = nn.Sequential(nn.Linear(640, 640), nn.ReLU(), nn.Linear(640, out_dim))
